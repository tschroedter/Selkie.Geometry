...
namespace Selkie.Geometry.Calculators
{
    public class CoordinatePairCalculator : ICoordinatePairCalculator
    {
        ...
        public CoordinatePairCalculator()
        {
            ...
            m_Xt1And2 = new Tuple<double, double>(double.NaN, double.NaN);
            m_Yt1And2 = new Tuple<double, double>(double.NaN, double.NaN);
        }
                                        ...
                                        [NotNull] Tuple<double, double> yt1And2)
        {
            ...
            m_Points = Calculate(circle, xt1And2, yt1And2);
        }
        ...
        {
            get { return m_Xt1And2; }
        }

        public Tuple<double, double> Yt1And2
        {
            get { return m_Yt1And2; }
        }
        ...
        internal Tuple<Point, Point> Calculate([NotNull] ICircle circle,
                                               ...
                                               [NotNull] Tuple<double, double> yt1And2)
        {
            if (AreInputFieldsValid(circle, xt1And2, yt1And2))
            {
            ...
            var pointOne = new Point(xt1, yt1);
            var pointTwo = new Point(xt2, yt2);

            if (!circle.IsPointOnCircle(pointOne))
            {
                pointOne = new Point(xt1, yt2);
                pointTwo = new Point(xt2, yt1);
        ...
        private static bool AreInputFieldsValid([NotNull] ICircle circle,
                                                ...
                                                [NotNull] Tuple<double, double> yt1And2)
        {
            return circle.IsUnknown ||
                   double.IsNaN(xt1And2.Item1) ||
                   double.IsNaN(xt1And2.Item2) ||
                   double.IsNaN(yt1And2.Item1) ||
                   double.IsNaN(yt1And2.Item2);
        }
    }
}