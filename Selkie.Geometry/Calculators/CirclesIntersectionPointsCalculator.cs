...
namespace Selkie.Geometry.Calculators
{
    public class CirclesIntersectionPointsCalculator : ICirclesIntersectionPointsCalculator
    {
        ...
        public CirclesIntersectionPointsCalculator([NotNull] ICirclePair circlePair)
        {
            ...
            if (IsSameCircles(circlePair, d, r0MinusR1Abs))
            {
                     ...
                     d >= r0MinusR1Abs)
            {
                ...
                {
                    var line = new Line(circlePair.Zero.CentrePoint, circlePair.One.CentrePoint);
        ...
        {
            get { return m_HasIntersectionPoints; }
        }

        public bool IsCirclesAreSame
        {
            get { return m_IsCirclesAreSame; }
        }

        public bool IsCirclesTouchAtSinglePoint
        {
            get { return m_IsCirclesTouchAtSinglePoint; }
        }

        public Point IntersectionPointOne
        {
            get { return m_IntersectionPointOne; }
        }

        public Point IntersectionPointTwo
        {
            get { return m_IntersectionPointTwo; }
        }
        ...
        private Tuple<Point, Point> CalculateIntersectionPoints([NotNull] ICirclePair circlePair)
        {
            ...
            {
                return CalculatePointsForHBiggerThanEpsilon(h, cy0, cy1, cx1, cx0, distance, a);
            }
        ...
        internal Tuple<Point, Point> CalculatePointsForSpecialCases([NotNull] ICirclePair circlePair)
        {
            ...
            return new Tuple<Point, Point>(Point.Unknown, Point.Unknown);
        }
        ...
        internal Tuple<Point, Point> CalculatePointsSameX([NotNull] ICirclePair circlePair)
        {
            ...
            {
                one = new Point(circlePair.Zero.X, circlePair.Zero.Y + circlePair.Zero.Radius);
                two = new Point(circlePair.One.X, circlePair.One.Y - circlePair.Zero.Radius);
            }
            else
            {
                one = new Point(circlePair.Zero.X, circlePair.Zero.Y - circlePair.Zero.Radius);
            ...
            return new Tuple<Point, Point>(one, two);
        }
        ...
        internal Tuple<Point, Point> CalculatePointsForSameY([NotNull] ICirclePair circlePair)
        {
            ...
            {
                one = new Point(circlePair.Zero.X + circlePair.Zero.Radius, circlePair.Zero.Y);
                two = new Point(circlePair.One.X - circlePair.One.Radius, circlePair.One.Y);
            }
            else
            {
                one = new Point(circlePair.Zero.X - circlePair.Zero.Radius, circlePair.Zero.Y);
                                                                                ...
                                                                                double a)
        {
            ...
            var one = new Point(ix1, iy1);
            var two = new Point(ix2, iy2);
