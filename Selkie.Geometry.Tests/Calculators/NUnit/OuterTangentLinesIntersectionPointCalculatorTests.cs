...
namespace Selkie.Geometry.Tests.Calculators.NUnit
{
    ...
    internal sealed class OuterTangentLinesIntersectionPointCalculatorTests
    {
        ...
        internal sealed class QuadrantFourAndTwoTests
        {
            ...
            public void Setup()
            {
                m_One = new Circle(new Point(10.0, -10.0), 5.0);
                m_Two = new Circle(new Point(-20.0, 20.0), 10.0);
            ...
            {
                var expected = new Point(40.0, -40.0);
        ...
        internal sealed class UnknownTests
        {
            ...
            {
                Assert.True(m_Calculator.IsUnknown, "IsUnknown");
                Assert.AreEqual(Point.Unknown, m_Calculator.IntersectionPoint, "IntersectionPoint");
            }
        }
