...
namespace Selkie.Geometry.Tests.Shapes.NUnit
{
    ...
    internal sealed class PolyineTests
    {
        ...
        public void Setup()
        {
            m_StartPointOne = new Point(-10.0, -10.0);
            m_EndPointOne = new Point(10.0, 10.0);
            m_StartPointTwo = new Point(-50.0, -50.0);
            m_EndPointTwo = new Point(100.0, 100.0);
        ...
        public void AddTest()
        {
            ...
            Assert.AreEqual(1, m_Polyline.Segments.Count(), "Count");
            Assert.AreEqual(m_Segment1, m_Polyline.Segments.First(), "First");
            Assert.AreEqual(1.0, m_Polyline.Length, "Length");
            Assert.AreEqual(m_StartPointOne, m_Polyline.StartPoint, "StartPoint");
            Assert.AreEqual(m_EndPointOne, m_Polyline.EndPoint, "EndtPoint");
        }
        ...
        public void AddTwiceTest()
        {
            ...
            Assert.AreEqual(2, m_Polyline.Segments.Count(), "Count");
            Assert.AreEqual(m_Segment1, m_Polyline.Segments.First(), "First");
            Assert.AreEqual(m_Segment2, m_Polyline.Segments.Last(), "Last");
            Assert.AreEqual(3.0, m_Polyline.Length, "Length");
            Assert.AreEqual(m_StartPointOne, m_Polyline.StartPoint, "StartPoint");
            Assert.AreEqual(m_EndPointTwo, m_Polyline.EndPoint, "EndtPoint");
        }

        [Test]
        public void DefaultEndPointTest()
        {
            Assert.AreEqual(Point.Unknown, m_Polyline.EndPoint);
        }

        [Test]
        public void DefaultSegmentsTest()
        {
            Assert.AreEqual(0, m_Polyline.Segments.Count());
        }

        [Test]
        public void DefaultStartPointTest()
        {
            Assert.AreEqual(Point.Unknown, m_Polyline.StartPoint);
        }
        ...
        public void DetermineEndPointReturnsPointUnknownForLastIsNullTest()
        {
            ...
            Assert.AreEqual(Point.Unknown, actual);
        }
        ...
        public void LengthTest()
        {
            ...
            Assert.AreEqual(3.0, m_Polyline.Length);
        }
