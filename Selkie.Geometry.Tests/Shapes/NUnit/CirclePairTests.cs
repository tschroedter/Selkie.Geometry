...
namespace Selkie.Geometry.Tests.Shapes.NUnit
{
    ...
    internal sealed class CirclePairTests
    {
        ...
        public void Setup()
        {
            m_Smaller = new Circle(3.0, 4.0, 5.0);
            m_Bigger = new Circle(30.0, 40.0, 20.0);
            m_ThreeIntersectingTwo = new Circle(45.0, 40.0, 10.0);
            m_ThreeInsideTwoIntersectingTwoPoints = new Circle(45.0, 40.0, 5.0);
            m_ThreeInsideTwo = new Circle(30.0, 40.0, 5.0);
            m_ThreeInsideTwoIntersectingOnePoint = new Circle(55.0, 40.0, 5.0);
        }
        ...
        {
            var pair = new CirclePair(m_Smaller, m_Bigger);

            NUnitHelper.AssertIsEquivalent(45.0, pair.Distance, 0.01, "Distance");
        }
        ...
        {
            var pair = new CirclePair(m_Bigger, m_ThreeInsideTwo);
        ...
        {
            var pair = new CirclePair(m_Bigger, m_ThreeInsideTwoIntersectingTwoPoints);
        ...
        {
            var pair = new CirclePair(m_Bigger, m_ThreeInsideTwoIntersectingOnePoint);
        ...
        {
            var pair = new CirclePair(m_Bigger, m_ThreeIntersectingTwo);
        ...
        {
            var pair = new CirclePair(m_Bigger, m_Smaller);

            Assert.AreEqual(m_Bigger, pair.Zero);
        }
        ...
        public void OneTest()
        {
            ...
            Assert.AreEqual(m_Smaller, pair.One);
        }
        ...
        public void RadiusZeroForFirstIsGreaterTest()
        {
            ...
            Assert.AreEqual(m_Bigger.Radius, pair.RadiusZero);
        }
