...
namespace Selkie.Geometry.Tests.Shapes.NUnit
{
    ...
    internal sealed class ArcSegmentTests
    {
        ...
        public void Setup()
        {
            m_Circle = new Circle(2.0, 3.0, 4.0);
            m_StartPoint = new Point(2.0, 7.0);
            m_EndPoint = new Point(2.0, -1.0);
            m_TurnDirection = Constants.TurnDirection.Counterclockwise;

            m_Segment = new ArcSegment(m_Circle, m_StartPoint, m_EndPoint, m_TurnDirection);
        }
        ...
        private void AssertCalculateLengthForDegrees(double degrees)
        {
            ...
            double actual = m_Segment.CalculateLength(radians, radius);

            NUnitHelper.AssertIsEquivalent(expected, actual, 0.01, "Length");
        }

        [Test]
        public void Azimuth0DegreesTest()
        {
            var endPoint = new Point(2.0, 7.0);

            var segment = new ArcSegment(m_Circle, m_StartPoint, endPoint);
        ...
        {
            var endPoint = new Point(2.0, -1.0);
        ...
        {
            var endPoint = new Point(6.0, 3.0);
        ...
        {
            var circle = new Circle(0.0, 0.0, 100.0);
            var startPoint = new Point(100.0, 0.0);
            var endPoint = new Point(-100.0, 0.0);
        ...
        public void AzimuthFor270DegreesTest()
        {
            var circle = new Circle(0.0, 0.0, 100.0);
            var startPoint = new Point(100.0, 0.0);
            var endPoint = new Point(0.0, 100.0);
        ...
        {
            var circle = new Circle(-25.0, 156.13, 100.0);
            var startPoint = new Point(-87.5, 78.06);
            var endPoint = new Point(37.5, 78.06);
            ...
            Assert.AreEqual(expected, actual, "RadiansClockwise");

            expected = Angle.FromRadians(1.3501690086490079);
            actual = segment.AngleCounterClockwise;

            Assert.AreEqual(expected, actual, "RadiansCounterClockwise");
        }

        [Test]
        public void CentrePointTest()
        {
            Assert.AreEqual(m_Circle.CentrePoint, m_Segment.CentrePoint);
        }

        [Test]
        public void EndPointTest()
        {
            Assert.AreEqual(m_EndPoint, m_Segment.EndPoint);
        }
        ...
        public void Length0DegreesTest()
        {
            ...
            NUnitHelper.AssertIsEquivalent(0.0, actual, 0.01, "Distance");
        }
        ...
        public void Length180DegreesTest()
        {
            ...
            NUnitHelper.AssertIsEquivalent(12.57, actual, 0.01, "Distance");
        }
        ...
        public void Length270DegreesTest()
        {
            ...
            NUnitHelper.AssertIsEquivalent(18.85, actual, 0.01, "Azimuth");
        }
        ...
        public void Length90DegreesTest()
        {
            ...
            NUnitHelper.AssertIsEquivalent(6.28, actual, 0.01, "Distance");
        }
        ...
        {
            Assert.AreEqual(m_Circle.Radius, m_Segment.Radius);
        }
        ...
        public void ReverseTest()
        {
            ...
            Assert.AreEqual(m_Segment.LengthClockwise, actual.Length, "Length");
            Assert.AreEqual(m_Segment.EndPoint, actual.StartPoint, "StartPoint");
            Assert.AreEqual(m_Segment.StartPoint, actual.EndPoint, "EndPoint");
            Assert.AreEqual(Constants.TurnDirection.Counterclockwise, actual.TurnDirection, "TurnDirection");
            Assert.AreEqual(m_Segment.AngleClockwise, actual.AngleClockwise, "RadiansClockwise");
        }

        [Test]
        public void StartPointTest()
        {
            Assert.AreEqual(m_StartPoint, m_Segment.StartPoint);
        }

        [Test]
        public void TurnDirectionTest()
        {
            Assert.AreEqual(m_TurnDirection, m_Segment.TurnDirection);
        }
        ...
        public void UnknonTest()
        {
            ...
            Assert.True(segment.IsUnknown, "IsUnknown");
            Assert.AreEqual(Point.Unknown, segment.CentrePoint, "CentrePoint");
            Assert.AreEqual(Point.Unknown, segment.StartPoint, "StartPoint");
            Assert.AreEqual(Point.Unknown, segment.EndPoint, "EndPoint");
            Assert.AreEqual(Constants.TurnDirection.Unknown, segment.TurnDirection, "TurnDirection");
        }
        ...
        {
            var circle = new Circle(0.0, 0.0, 100.0);
            var startPoint = new Point(170.71, 170.71);

            Assert.False(m_Segment.ValidatePoint(circle, startPoint));
        }
        ...
        {
            var circle = new Circle(0.0, 0.0, 100.0);
            var startPoint = new Point(70.71, 70.71);

            Assert.True(m_Segment.ValidatePoint(circle, startPoint));
        }
        ...
        {
            var circle = new Circle(0.0, 0.0, 100.0);
            var startPoint = new Point(0.0, 100.0);
            var endPoint = new Point(170.71, 170.71);

            Assert.Throws<ArgumentException>(() => m_Segment.ValidateStartAndEndPoint(circle, startPoint, endPoint));
        }
        ...
        {
            var circle = new Circle(0.0, 0.0, 100.0);
            var startPoint = new Point(100.0, 100.0);
            var endPoint = new Point(170.71, 170.71);
